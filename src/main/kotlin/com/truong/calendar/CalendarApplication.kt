...
class CalendarApplication {
  ...
  private fun calculateNextBizDay(calendarCalculator: CalendarCalculator) {
  ...
  private fun checkDateAction(calendarCalculator: CalendarCalculator) {
  ...
  private fun userSelectAction(greeting: () -> Unit): Int {
    do {
      greeting()
      try {
